...
class FailedLoginTrackerService {
  ...
  async recordFailedLogin(
    ...
    console.warn(`⚠️ Failed login attempt ${attempt.count}/${this.MAX_ATTEMPTS} for ${type}: ${identifier}`)
  }
  ...
  private async triggerAlert(
    ...
    console.error(`🚨 SECURITY ALERT: ${attemptCount} failed login attempts from ${type}: ${identifier}`)
